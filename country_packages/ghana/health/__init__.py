"""
Ghana Country Package - Health

Package-level integrity check, same contract as Kenya's health module.
"""

from dataclasses import dataclass

from country_packages.ghana import manifest as _manifest
from country_packages.ghana.providers import PROVIDERS
