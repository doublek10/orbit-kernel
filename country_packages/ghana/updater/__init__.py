"""
Ghana Country Package - Automatic Update Engine

Turns a detected monitoring change into a versioned Update Proposal,
same contract as Kenya's updater module.
"""
...
def build_proposal(
    *,
    ...
    return UpdateProposal(
        ...
        rollback_plan=f"Restore country_packages/ghana at version {current_version}.",
