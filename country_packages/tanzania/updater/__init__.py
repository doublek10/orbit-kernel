"""
Tanzania Country Package - Automatic Update Engine

Turns a detected monitoring change into a versioned Update Proposal,
same contract as Kenya's, Ghana's and Uganda's updater modules.
"""
...
def build_proposal(
    *,
    ...
    return UpdateProposal(
        ...
        rollback_plan=f"Restore country_packages/tanzania at version {current_version}.",
